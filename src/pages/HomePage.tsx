...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-0 pb-0 relative z-10 bg-white text-slate-900 overflow-x-hidden">
      ...
      <section className="relative min-h-0 sm:min-h-screen bg-white text-slate-900 pt-16 sm:pt-24 pb-6 sm:pb-12 flex items-center overflow-hidden border-b border-slate-200">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none z-0">
          <img
            ...
            className="w-full h-full object-cover object-top opacity-40 sm:opacity-100 sm:object-center bg-white"
          />
        </div>

        {/* Soft Mobile & Desktop White Gradient Overlay for Contrast */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-20 w-full">
          <div className="max-w-xs sm:max-w-lg space-y-2.5 sm:space-y-4">
            
            {/* Top Ribbon */}
            <div className="flex items-center gap-1.5 text-[8px] sm:text-[10px] font-mono text-[#DC2626] font-extrabold uppercase tracking-widest">
            ...
            <div className="space-y-0.5">
              {language === 'ta' ? (
                <>
                  <h2 className="font-serif text-xs sm:text-xl lg:text-2xl font-bold leading-tight text-slate-900">
                    எழுத்தில் பிறக்கும் உலகங்கள்.
                  </h2>
                  <h2 className="font-serif text-xs sm:text-xl lg:text-2xl font-bold leading-tight text-[#DC2626]">
              ...
              <div className="w-8 sm:w-12 h-[2px] bg-[#DC2626] mt-0.5" />
            </div>

            {/* Author Name Heading */}
            <div className="space-y-0 pt-0.5">
              <h1 className="font-serif font-black text-xl sm:text-4xl lg:text-5xl tracking-tight leading-none text-slate-900 uppercase">
                {language === 'ta' ? 'ராகுல்' : 'RAHUL'}
              </h1>
              <h1 className="font-serif font-black text-xl sm:text-4xl lg:text-5xl tracking-tight leading-none text-[#DC2626] uppercase">
                {language === 'ta' ? 'செபாஸ்டியன்' : 'SEBASTIAN'}
              </h1>
              <div className="pt-0.5 text-[8px] sm:text-[10px] font-mono tracking-[0.16em] text-[#DC2626] font-extrabold uppercase">
                {language === 'ta'
            ...
            {/* Subtext Quote */}
            <p className="font-serif italic text-[11px] sm:text-sm text-slate-700 leading-snug max-w-xs sm:max-w-sm">
              {language === 'ta'
            ...
            <div className="flex flex-wrap items-center gap-1.5 pt-0.5">
              <RouterLink
                to="/books"
                className="inline-flex items-center gap-1.5 px-3.5 sm:px-5 py-1.5 sm:py-2.5 rounded-full bg-[#DC2626] text-white font-sans text-[11px] sm:text-xs font-bold tracking-wide hover:bg-[#B91C1C] transition-all shadow-sm"
              >
              ...
              <RouterLink
                to="/writings"
                className="inline-flex items-center gap-1.5 px-3.5 sm:px-5 py-1.5 sm:py-2.5 rounded-full border border-slate-900 text-slate-900 bg-white/90 backdrop-blur-xs font-sans text-[11px] sm:text-xs font-bold tracking-wide hover:bg-slate-900 hover:text-white transition-all shadow-xs"
              >
            ...
            {/* Signature & Motto Bar */}
            <div className="pt-1.5 border-t border-slate-200 flex flex-wrap items-center justify-between gap-1 text-[8px] sm:text-[10px] font-mono text-slate-600 max-w-xs sm:max-w-sm">
      ...
      {/* ========================================================================= */}
      <section className="bg-slate-100 py-10 md:py-16 relative clip-angled-right border-b border-slate-200">
      ...
      {/* 3. FEATURED POEM */}
      {/* ========================================================================= */}
      <section className="bg-slate-950 text-white py-12 md:py-18 relative overflow-hidden border-b border-[#DC2626]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-6 relative z-10">
          ...
          <div className="font-serif text-base sm:text-3xl md:text-4xl text-white font-bold leading-relaxed whitespace-pre-line italic tracking-wide p-4 sm:p-6 border-l-4 border-[#DC2626] bg-slate-900/90 rounded text-left my-4 shadow-2xl">
      ...
      <section className="bg-slate-950 text-white py-14 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          <div className="p-6 md:p-12 bg-slate-900 rounded-sm border-2 border-[#DC2626] shadow-2xl space-y-8 card-notch">
            
            <div className="text-center space-y-2 max-w-2xl mx-auto">
              <span className="text-[11px] font-mono uppercase tracking-widest text-[#DC2626] font-extrabold">
                DIRECT CONTACT — தொடர்பு (ERODE, TAMIL NADU)
              </span>
              <h2 className="font-slanted text-2xl sm:text-5xl uppercase tracking-tight text-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto font-mono text-xs font-extrabold">
              <a
                ...
                className="p-4 sm:p-5 bg-slate-950 border border-slate-800 rounded-sm flex flex-col items-center justify-center gap-2 hover:border-[#DC2626] hover:bg-[#DC2626]/20 transition-all text-center group"
              >
